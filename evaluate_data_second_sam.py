"""
Evaluate a SAM-trained ResNet-18 checkpoint on the balanced DATA_second split.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate SAM ResNet-18 on DATA_second.")
